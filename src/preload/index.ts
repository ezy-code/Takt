...
contextBridge.exposeInMainWorld('api', {
  ...
  addTask: (name: string, description: string, description_md?: string, description_html?: string, statusId?: number, projectId?: number, today?: boolean | string | null) => ipcRenderer.invoke('add-task', name, description, description_md, description_html, statusId, projectId, today),
  deleteTask: (id: number) => ipcRenderer.invoke('delete-task', id),
  updateTask: (id: number, name: string, description: string, description_md?: string, description_html?: string, statusId?: number, projectId?: number, today?: boolean | string | null) => ipcRenderer.invoke('update-task', id, name, description, description_md, description_html, statusId, projectId, today),
  getProjects: () => ipcRenderer.invoke('get-projects'),
  getProject: (id: number) => ipcRenderer.invoke('get-project', id),
  addProject: (name: string, description?: string, description_md?: string, description_html?: string) => ipcRenderer.invoke('add-project', name, description, description_md, description_html),
  updateProject: (id: number, name: string, description?: string, description_md?: string, description_html?: string) => ipcRenderer.invoke('update-project', id, name, description, description_md, description_html),
