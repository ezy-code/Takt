...
contextBridge.exposeInMainWorld('api', {
  ...
  addTask: (name: string, description: string, description_md?: string, description_html?: string, statusId?: number, today?: boolean | string | null) => ipcRenderer.invoke('add-task', name, description, description_md, description_html, statusId, today),
  deleteTask: (id: number) => ipcRenderer.invoke('delete-task', id),
  updateTask: (id: number, name: string, description: string, description_md?: string, description_html?: string, statusId?: number, today?: boolean | string | null) => ipcRenderer.invoke('update-task', id, name, description, description_md, description_html, statusId, today),
