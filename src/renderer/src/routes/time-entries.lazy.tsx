import { Container, Title, Table, Text, Button, Card, SimpleGrid } from '@mantine/core'
      ...
      {summary && (
        <SimpleGrid cols={3} mb="xl">
          <Card withBorder padding="md" radius="md">
            ...
            <Text size="xl" fw={700}>{summary.totalSessions}</Text>
          </Card>
          <Card withBorder padding="md" radius="md">
            <Text size="xs" c="dimmed" tt="uppercase" fw={700}>Total Time</Text>
            <Text size="xl" fw={700}>{formatDuration(summary.totalDuration)}</Text>
          </Card>
          <Card withBorder padding="md" radius="md">
            <Text size="xs" c="dimmed" tt="uppercase" fw={700}>Today</Text>
            <Text size="xl" fw={700}>{formatDuration(summary.todayDuration)}</Text>
          </Card>
        </SimpleGrid>
      )}
