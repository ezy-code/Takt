...
import { Group, Button, Text, Modal, Stack, ActionIcon, Box } from '@mantine/core'
...
export function TimerControl({ taskId, duration, startTime: propStartTime }: TimerControlProps) {
  ...
  if (!taskId) {
    return (
      <Group gap={6} wrap="nowrap" align="center">
        ...
        <Text size="sm" fw={700} c={propStartTime ? 'green' : 'blue'}
  ...
  const handleStart = async () => {
    if (activeEntry) { setConflict(true); return }
